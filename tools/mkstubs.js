...
var stubs = [];
var d = '';
d += 'EXTERN int '+opts.pret+'_Stubs__initialize(Jsi_Interp *interp, double version, const char* name, int flags, const char *md5, int bldFlags, int stubSize, void **ptr); /*STUB = 0*/\n';
...
rc += '#define '+opts.preu+'_STUBS_MD5 "'+sys.md5(fstub)+'"\n\n';
...
rc += opts.pret+'_Stubs), (void**)&'+opts.prefix+'StubsPtr):JSI_ERROR)\n';
rc += '#endif\n\n';
rc += fstub;
