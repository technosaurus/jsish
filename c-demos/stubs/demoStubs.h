...
#define DEMO_STUBS_MD5 "adde094d85e7dc1d80911b0caa8fd384"
...
#define Demo_StubsInit(interp,flags) (jsiStubsPtr && jsiStubsPtr->sig == \
  ...
  DEMO_VERSION, DEMO_STUBS_MD5, DEMO_STUBS_BLDFLAGS, sizeof(Demo_Stubs), (void**)&demoStubsPtr):JSI_ERROR)
#endif
...
typedef struct Demo_Stubs {
    ...
    char* md5;
    void *hook;
    int(*_Demo_Stubs__initialize)(Jsi_Interp *interp, double version, const char* name, int flags, const char *md5, int bldFlags, int stubSize, void **ptr);
