...
#define JSI_STUBS_MD5 "0c3476ed39b74cc6ece8ff411287476e"
...
#define Jsi_StubsInit(interp,flags) (jsiStubsPtr && jsiStubsPtr->sig == \
  ...
  JSI_VERSION, JSI_STUBS_MD5, JSI_STUBS_BLDFLAGS, sizeof(Jsi_Stubs), (void**)&jsiStubsPtr):JSI_ERROR)
#endif
...
typedef struct Jsi_Stubs {
    ...
    char* md5;
    void *hook;
    int(*_Jsi_Stubs__initialize)(Jsi_Interp *interp, double version, const char* name, int flags, const char *md5, int bldFlags, int stubSize, void **ptr);
    Jsi_Interp*(*_Jsi_InterpCreate)(Jsi_Interp *parent, int argc, char **argv, Jsi_Value *opts);
    void(*_Jsi_InterpDelete)( Jsi_Interp* interp);
    Jsi_DeleteProc*(*_Jsi_InterpOnDelete)(Jsi_Interp *interp, Jsi_DeleteProc *freeProc);
    ...
    char**(*_Jsi_FunctionLocals)(Jsi_Interp *interp, Jsi_Value *func, int *argcPtr);
    char**(*_Jsi_FunctionArguments)(Jsi_Interp *interp, Jsi_Value *func, int *argcPtr);
    ...
    int(*_Jsi_Strlen)(const char *str);
    int(*_Jsi_StrlenSet)(const char *str, int len);
    ...
    char*(*_Jsi_SubstrDup)(const char *a, int start, int len);
    char*(*_Jsi_Strcatdup)(const char *str1, const char *str2);
    char*(*_Jsi_Strchr)(const char *str, int c);
    int(*_Jsi_Strpos)(char *str, int start, char *nid, int nocase);
    int(*_Jsi_Strrpos)(char *str, int start, char *nid, int nocase);
    ...
    Jsi_Obj*(*_Jsi_ObjNewArray)(Jsi_Interp *interp, Jsi_Value **items, int count);
    ...
    Jsi_Value*(*_Jsi_ValueNewString)(Jsi_Interp *interp, const char *s);
    ...
    int(*_Jsi_ValueGetBoolean)(Jsi_Interp *interp, Jsi_Value *pv, int *val);
    ...
    Jsi_Value*(*_Jsi_ValueMakeStringDup)(Jsi_Interp *interp, Jsi_Value *v, const char *s);
    ...
    void        (*_Jsi_ValueToPrimitive)(Jsi_Interp *interp, Jsi_Value *v);
    const char* (*_Jsi_ValueToString)(Jsi_Interp *interp, Jsi_Value *v);
    ...
    Jsi_Value*(*_Jsi_ValueObjLookup)(Jsi_Interp *interp, Jsi_Value *target, char *key, int iskeystr);
    ...
    Jsi_Regex*(*_Jsi_RegExpNew)(Jsi_Interp *interp, char *regtxt, int flag);
    ...
    void(*_Jsi_SplitStr)(const char *str, int *argcPtr, char ***argvPtr,  char *s, Jsi_DString *dStr);
    ...
    Jsi_Hash*(*_Jsi_HashNew )(Jsi_Interp *interp, unsigned int keyType, Jsi_DeleteProc *freeProc);
    ...
    int(*_Jsi_HashKeysDump)(Jsi_Interp *interp, Jsi_Hash *hashPtr, Jsi_Value *ret);
    ...
    Jsi_HashEntry*(*_Jsi_HashEntryCreate )(Jsi_Hash *hashPtr, const void *key, int *isNew);
    void(*_Jsi_HashEntryDelete )(Jsi_HashEntry *entryPtr);
    ...
    Jsi_Tree*(*_Jsi_TreeNew)(Jsi_Interp *interp, unsigned int keyType);
    ...
    Jsi_TreeEntry*(*_Jsi_TreeEntryCreate)(Jsi_Tree *treePtr, const void *key, int *isNew);
    void(*_Jsi_TreeEntryDelete)(Jsi_TreeEntry *entryPtr);
    Jsi_TreeEntry*(*_Jsi_TreeSearchFirst)(Jsi_Tree *treePtr, Jsi_TreeSearch *searchPtr, int flags);
    ...
    const char*(*_Jsi_OptionTypeStr)(Jsi_OptionTypes typ);
    ...
    int(*_Jsi_OptionsSet)(Jsi_Interp *interp, Jsi_OptionSpec *specs, char *option, void* data, Jsi_Value *value, int flags);
    int(*_Jsi_OptionsDump)(Jsi_Interp *interp, Jsi_OptionSpec *specs, void *data, Jsi_Value* ret, int flags);
    Jsi_Value*(*_Jsi_OptionsCustomPrint)(void* clientData, Jsi_Interp *interp, char *optionName, void *data, int offset);
    Jsi_OptionSpec*(*_Jsi_OptionsDup)(Jsi_Interp *interp, const Jsi_OptionSpec *staticSpecs);
    void(*_Jsi_StackInit)(Jsi_Stack *stack);
    ...
    void(*_Jsi_StackFreeElements)(Jsi_Stack *stack, Jsi_DeleteProc *freeFunc);
    int(*_Jsi_MutexLock)(Jsi_Interp *interp, void *mtx);
    void(*_Jsi_MutexUnlock)(Jsi_Interp *interp, void *mtx);
    void(*_Jsi_MutexInit)(Jsi_Interp *interp, void *mtx);
    void(*_Jsi_MutexDone)(Jsi_Interp *interp, void *mtx);
    void*(*_Jsi_MutexNew)(Jsi_Interp *interp);
    ...
    void*(*_Jsi_HashConf)(Jsi_Hash *hashPtr, int op, ...);
    int(*_Jsi_TreeSize)(Jsi_Tree *treePtr);
    void*(*_Jsi_TreeConf)(Jsi_Tree *treePtr, int op, ...);
    int(*_Jsi_SafeAccess)(Jsi_Interp *interp, Jsi_Value* file, int toWrite);
...
#define Jsi_InterpCreate(n0,n1,n2,n3) JSISTUBCALL(jsiStubsPtr, _Jsi_InterpCreate(n0,n1,n2,n3))
#define Jsi_InterpDelete(n0) JSISTUBCALL(jsiStubsPtr, _Jsi_InterpDelete(n0))
#define Jsi_InterpOnDelete(n0,n1) JSISTUBCALL(jsiStubsPtr, _Jsi_InterpOnDelete(n0,n1))
...
#define Jsi_FunctionLocals(n0,n1,n2) JSISTUBCALL(jsiStubsPtr, _Jsi_FunctionLocals(n0,n1,n2))
...
#define Jsi_SubstrDup(n0,n1,n2) JSISTUBCALL(jsiStubsPtr, _Jsi_SubstrDup(n0,n1,n2))
#define Jsi_Strcatdup(n0,n1) JSISTUBCALL(jsiStubsPtr, _Jsi_Strcatdup(n0,n1))
...
#define Jsi_ObjNewArray(n0,n1,n2) JSISTUBCALL(jsiStubsPtr, _Jsi_ObjNewArray(n0,n1,n2))
...
#define Jsi_ValueNewString(n0,n1) JSISTUBCALL(jsiStubsPtr, _Jsi_ValueNewString(n0,n1))
...
#define Jsi_ValueMakeStringDup(n0,n1,n2) JSISTUBCALL(jsiStubsPtr, _Jsi_ValueMakeStringDup(n0,n1,n2))
...
#define Jsi_ValueToPrimitive(n0,n1) JSISTUBCALL(jsiStubsPtr, _Jsi_ValueToPrimitive(n0,n1))
#define Jsi_ValueToString(n0,n1) JSISTUBCALL(jsiStubsPtr, _Jsi_ValueToString(n0,n1))
...
#define Jsi_HashKeysDump(n0,n1,n2) JSISTUBCALL(jsiStubsPtr, _Jsi_HashKeysDump(n0,n1,n2))
...
#define Jsi_HashEntryCreate (n0,n1,n2) JSISTUBCALL(jsiStubsPtr, _Jsi_HashEntryCreate (n0,n1,n2))
...
#define Jsi_TreeNew(n0,n1) JSISTUBCALL(jsiStubsPtr, _Jsi_TreeNew(n0,n1))
...
#define Jsi_TreeEntryCreate(n0,n1,n2) JSISTUBCALL(jsiStubsPtr, _Jsi_TreeEntryCreate(n0,n1,n2))
#define Jsi_TreeEntryDelete(n0) JSISTUBCALL(jsiStubsPtr, _Jsi_TreeEntryDelete(n0))
#define Jsi_TreeSearchFirst(n0,n1,n2) JSISTUBCALL(jsiStubsPtr, _Jsi_TreeSearchFirst(n0,n1,n2))
...
#define Jsi_OptionTypeStr(n0) JSISTUBCALL(jsiStubsPtr, _Jsi_OptionTypeStr(n0))
...
#define Jsi_StackInit(n0) JSISTUBCALL(jsiStubsPtr, _Jsi_StackInit(n0))
...
#define Jsi_StackFreeElements(n0,n1) JSISTUBCALL(jsiStubsPtr, _Jsi_StackFreeElements(n0,n1))
...
#define Jsi_MutexInit(n0,n1) JSISTUBCALL(jsiStubsPtr, _Jsi_MutexInit(n0,n1))
#define Jsi_MutexDone(n0,n1) JSISTUBCALL(jsiStubsPtr, _Jsi_MutexDone(n0,n1))
#define Jsi_MutexNew(n0) JSISTUBCALL(jsiStubsPtr, _Jsi_MutexNew(n0))
...
#define Jsi_UNUSED_1(n0) JSISTUBCALL(jsiStubsPtr, _Jsi_UNUSED_1(n0))
...
#define Jsi_SafeAccess(n0,n1,n2) JSISTUBCALL(jsiStubsPtr, _Jsi_SafeAccess(n0,n1,n2))
